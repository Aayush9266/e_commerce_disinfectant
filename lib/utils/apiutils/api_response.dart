...
import 'package:e_commerce_disinfectant/utils/apiutils/api_base_helper.dart';
...
class ApiResponse<T> {
  ...
  static ApiResponse<dynamic> returnResponse<T>(Response response, T apiResponse) {
    ...
    } else if (response.statusCode == ApiResponseCode.success200 ||
        response.statusCode == ApiResponseCode.success201) {
